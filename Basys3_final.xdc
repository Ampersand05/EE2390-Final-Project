...
#set_property PACKAGE_PIN W17 [get_ports {LoadQ[0]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {LoadQ[0]}]
#set_property PACKAGE_PIN W15 [get_ports {LoadQ[1]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {LoadQ[1]}]
#set_property PACKAGE_PIN V15 [get_ports {LoadQ[2]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {LoadQ[2]}]
#set_property PACKAGE_PIN W14 [get_ports {LoadQ[3]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {LoadQ[3]}]
#set_property PACKAGE_PIN W13 [get_ports {sw[7]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {sw[7]}]
#set_property PACKAGE_PIN V2 [get_ports {doLoad}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {doLoad}]
...
#set_property PACKAGE_PIN U15 [get_ports {PN}]					
...
set_property PACKAGE_PIN T17 [get_ports lap]						
...
#set_property PACKAGE_PIN J1 [get_ports clk]					
	#set_property IOSTANDARD LVCMOS33 [get_ports clk]
##Sch name = JA2
#set_property PACKAGE_PIN L2 [get_ports {Q[0]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {Q[0]}]
##Sch name = JA3
#set_property PACKAGE_PIN J2 [get_ports {Q[1]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {Q[1]}]
##Sch name = JA4cv
#set_property PACKAGE_PIN G2 [get_ports {Q[2]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {Q[2]}]
##Sch name = JA7
#set_property PACKAGE_PIN H1 [get_ports {Q[3]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {Q[3]}]
##Sch name = JA8
